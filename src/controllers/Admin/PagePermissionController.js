...
//     const sortBy = req.query.sort || "pageName"; 
...
// New function to get all active page IDs
export const getAllPermissionPageIds = async (req, res) => {
  try {
    ...
    console.error("Error fetching all page IDs:", error);
    res.status(500).json({ message: "Internal server error" });
  }
};
