...
export const createMenu = async (req, res) => {
  let transaction;
  try {
    const { en_title, od_title, en_description, od_description, link, status } = req.body;
...
export const updateMenu = async (req, res) => {
  ...
  try {
    ...
    const { en_title, od_title, en_description, od_description, link, status, remove_image } = req.body;
    // Validate input
